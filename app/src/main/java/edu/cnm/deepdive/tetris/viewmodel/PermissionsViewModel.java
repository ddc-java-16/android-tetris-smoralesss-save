...
import edu.cnm.deepdive.tetris.service.PermissionsRepository;
import edu.cnm.deepdive.tetris.controller.PermissionsExplanationFragment;
...
public class PermissionsViewModel extends ViewModel implements DefaultLifecycleObserver {
   ...
   *                      PermissionsExplanationFragment}.
   */
