...
public class PermissionsExplanationFragment extends DialogFragment {
  ...
  public interface OnAcknowledgeListener {
    ...
    /**
     * Invoked after user acknowledgement of permission rationales. An implementation should then
     * resume the permissions flow, by invoking {@link
     * edu.cnm.deepdive.appstarter.viewmodel.PermissionsViewModel#requestPermissions(Activity,
     * String[])}.
     *
